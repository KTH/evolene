...
class FromImageStep(AbstractPipelineStep):
    ...
    def run_step(self, data):
        ...
        if self.validate(from_line, data):
            ...
            self.step_warning()
            slack.send(text)
            ci_status.post_platform_validation_run(data, short_from, 7, 'Dockerfile is based on an old image')
